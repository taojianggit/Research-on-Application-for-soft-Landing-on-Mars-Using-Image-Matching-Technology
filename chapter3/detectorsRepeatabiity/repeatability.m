function [erro,repeat,corresp, match_score,matches, twi]=repeatability(file1,file2,H,imf1,imf2, common_part)
%
%
...
feat1(1:5,1:s1)=f1(1:5,1:s1);assignin('base','feat1',feat1)
feat2(1:5,1:s2)=f2(1:5,1:s2);assignin('base','feat2',feat2)
if size(f1,1)>1
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if common_part==1
        ...
        fprintf(1,'nb of regions in common part in image1 %d.\n',size(feat1,1));assignin('base','feat1',feat1);assignin('base','feat1t',feat1t)
        fprintf(1,'nb of regions in common part in image2 %d.\n',size(feat2,1));assignin('base','feat2',feat2);assignin('base','feat2t',feat2t)
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    end 

sf=min([size(feat1,1) size(feat2,1)]);
...
[wout, twout, dout, tdout]=c_eoverlap(feat1,feat2t,common_part);assignin('base','wout',wout);assignin('base','twout',twout);assignin('base','dout',dout)
t=toc;
fprintf(1,' %.1f sec.\n',t);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
matches=0;
twi=[];
assignin('base','isDescriptor',isDescriptor)
if isDescriptor
    ...
    dx=(dout<10000).*(twi);assignin('base','dx',dx)
    matches=sum(sum(dx));assignin('base','matches',matches)
