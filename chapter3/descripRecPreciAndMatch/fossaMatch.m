...
original=imread('E:\MyResearch\paper\image\matchFeatures\Fossa\0.jpg');

% %% zoom
I1=imresize(original,zoomPara);
imwrite(I1,strcat('E:\MyResearch\paper\image\matchFeatures\Fossa\zoom.jpg'));
...
I2=imcrop(I2,[cc(2),cc(1)-400,1024,1024]);
%imwrite(I2,strcat('E:\MyResearch\paper\image\matchFeatures\Fossa\rotate.jpg'));


% %% blur
PSF = fspecial('motion',blurPara,0);
I3= imfilter(I2,PSF);
imwrite(I3, strcat('E:\MyResearch\paper\image\matchFeatures\Fossa\distorted.jpg'));
...
%% %% akaze region
pts1=importdata('E:\MyResearch\paper\image\matchFeatures\Fossa\pts1.txt');
angle1=importdata('E:\MyResearch\paper\image\matchFeatures\Fossa\kpts1angle.txt');
size1=importdata('E:\MyResearch\paper\image\matchFeatures\Fossa\kpts1size.txt');

pts2=importdata('E:\MyResearch\paper\image\matchFeatures\Fossa\pts2.txt');
angle2=importdata('E:\MyResearch\paper\image\matchFeatures\Fossa\kpts2angle.txt');
size2=importdata('E:\MyResearch\paper\image\matchFeatures\Fossa\kpts2size.txt');
...
save(['E:\MyResearch\paper\image\matchFeatures\Fossa\','region1.mat'],'region1')
save(['E:\MyResearch\paper\image\matchFeatures\Fossa\','region2.mat'],'region2')

dakaze1=importdata('E:\MyResearch\paper\image\matchFeatures\Fossa\desc1.txt');
dakaze2=importdata('E:\MyResearch\paper\image\matchFeatures\Fossa\desc2.txt');
...
%% kaze region
dkaze1=importdata('E:\MyResearch\paper\image\matchFeatures\Fossa\kdesc1.txt');
dkaze2=importdata('E:\MyResearch\paper\image\matchFeatures\Fossa\kdesc2.txt');
...
%  akaze surf
aksu=indexPairsak;
[intersectIndexPairs1,intersetIndex1]=intersect(indexPairsak(:,1),indexPairssu(:,1));%intersetIndex1 is index of indexPairsk that overlap with indexpairssu
...
fprintf('akaze&surf   matched indexpairs: %d\n',matchedpts1);
fprintf('akaze&surf correct  matched indexpairs: %d\n',innerpts1);
