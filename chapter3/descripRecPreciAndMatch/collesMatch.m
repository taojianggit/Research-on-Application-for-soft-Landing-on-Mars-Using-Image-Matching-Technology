...
original=imread('E:\MyResearch\paper\image\matchFeatures\Colles\0.jpg');

% %% zoom
I1=imresize(original,zoomPara);
imwrite(I1,strcat('E:\MyResearch\paper\image\matchFeatures\Colles\zoom.jpg'));
...
I2=imcrop(I2,[cc(2)-500,cc(1)-500,1024,1024]);
%imwrite(I2,strcat('E:\MyResearch\paper\image\matchFeatures\Colles\rotate.jpg'));


% %% blur
PSF = fspecial('motion',blurPara,0);
I3= imfilter(I2,PSF);
imwrite(I3, strcat('E:\MyResearch\paper\image\matchFeatures\Colles\distorted.jpg'));
...
%% %% akaze region
pts1=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\pts1.txt');
angle1=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\kpts1angle.txt');
size1=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\kpts1size.txt');

pts2=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\pts2.txt');
angle2=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\kpts2angle.txt');
size2=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\kpts2size.txt');
...
save(['E:\MyResearch\paper\image\matchFeatures\Colles\','region1.mat'],'region1')
save(['E:\MyResearch\paper\image\matchFeatures\Colles\','region2.mat'],'region2')

dakaze1=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\desc1.txt');
dakaze2=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\desc2.txt');
...
%% kaze region
dkaze1=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\kdesc1.txt');
dkaze2=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\kdesc2.txt');
...
save(['E:\MyResearch\paper\image\matchFeatures\Colles\','sift1.mat'],'d1')
save(['E:\MyResearch\paper\image\matchFeatures\Colles\','sift2.mat'],'d2')
dsift1=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\sift1.mat');
dsift2=importdata('E:\MyResearch\paper\image\matchFeatures\Colles\sift2.mat');
...
% [tform5,inlierPtsDistorted5,inlierPtsOriginal5] = estimateGeometricTransform(matchedPtsDistorted5,matchedPtsOriginal5,'projective','MaxNumTrials' ,1000,'Confidence',10,'MaxDistance',16);
...
% 
N2=size(inlierPtsDistorted2,1);
figure('color','white')
showMatchedFeatures(original,distorted,inlierPtsOriginal2(1:50:N2,:),inlierPtsDistorted2(1:50:N2,:),'montage');
% 
